...
export default {
    ...
    methods: {
        ...
        handleAddCategory(formData) {
            this.$store.dispatch("createCategories", formData).then(() => {
                this.visible = false;
                this.modalState = "";
                this.fetchCategories();
            }).catch((err) => {
        ...
        handleEditCategory(formData) {
            this.$store.dispatch("editCategories", { id: this.currentCategoryId, name: formData.name }).then(() => {
                this.visible = false;
                this.modalState = "";
                this.fetchCategories();
            }).catch((err) => {
        ...
        handleDelete() {
            this.$store.dispatch("deleteCategories", this.currentCategoryId).then(() => {
                this.visible = false;
                this.modalState = "";
                this.fetchCategories();
            }).catch((err) => {
